...
return [
    ...
    'description' => 'API REST para gerenciamento de clientes, contratos e cobranças.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Use o endpoint de autenticação para obter acesso à aplicação.',
    ],
    ...
    'postman' => [
        ...
        'overrides' => [
            'info.name' => 'Amar Assist Billing API',
        ],
    ],
    ...
    'openapi' => [
        ...
        'overrides' => [
            'info.version' => '1.0.0',
            'info.title' => 'Amar Assist Billing API',
            'info.description' => 'API do sistema de cobranças desenvolvido para o desafio técnico Amar Assist.',
        ],
